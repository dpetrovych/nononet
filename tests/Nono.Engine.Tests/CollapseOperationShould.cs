...
namespace Nono.Engine.Tests
{
    public class CollapseOperationShould
    {
        ...
        {
            var line = CollapseOperation.Run(new ushort[] { 3 }, "     ".AsSpan());
        ...
        {
            var line = CollapseOperation.Run(new ushort[] { 2 }, "    xxxxxxxx  xxxxx ".AsSpan());
        ...
        {
            var line = CollapseOperation.Run(new ushort[] { 2, 1 }, "     ".AsSpan());
        ...
        {
            var line = CollapseOperation.Run(new ushort[] { 2, 1 }, "  00 0".AsSpan());
        ...
        {
            var line = CollapseOperation.Run(new ushort[] { 1, 2, 3 }, "          ".AsSpan());
